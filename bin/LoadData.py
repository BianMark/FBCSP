...
class LoadBCIC(LoadData):
    '''Subclass of LoadData for loading BCI Competition IV Dataset 2a A01T.gdf '''
    def __init__(self, file_to_load, *args):
        self.stimcodes = ('769', '770', '771', '772')  # depend on file (A01T.gdf)
        self.file_to_load = file_to_load
        self.channels_to_remove = ['EOG-left', 'EOG-central', 'EOG-right']  # depend on dataset
